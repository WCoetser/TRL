...
{
  /// <summary>
  /// Abstract syntax tree node for associative-commutative terms
  /// </summary>
  public class AstAcTerm : AstTermBase
  {
    public Token TermName { get; private set; }
    public AstArgumentList TermArguments { get; set; }

    public AstAcTerm(Token termName, AstArgumentList termArguments)
    {
      TermName = termName;
